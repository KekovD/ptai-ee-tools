package com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v490.tasks;
...
import static com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v490.converters.IssuesConverter.convert;
...
public class GenericAstTasksImpl extends AbstractTaskImpl implements GenericAstTasks {
    ...
    public void waitForComplete(@NonNull ScanBrief scanBrief) throws InterruptedException {
        ...
        com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v490.tasks.GenericAstTasksImpl.ProjectPollingThread pollingThread = new com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v490.tasks.GenericAstTasksImpl.ProjectPollingThread(client, scanBrief, queue);
    ...
    public ScanBrief createScanBrief(@NonNull final UUID projectId, @NonNull final UUID scanResultId) throws GenericException {
        ...
        ServerVersionTasks serverVersionTasks = new com.ptsecurity.appsec.ai.ee.utils.ci.integration.api.v490.tasks.ServerVersionTasksImpl(client);
